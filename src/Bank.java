...
public class Bank {
	...
	/*
	 * Accounts are read from a fixed-width file. Each account is represented as a
	 * single line of text. These start and end indexes help to parse the line of
	 * text into individual account fields.
	 */
	...
	/*
	 * Initializes the Bank's internal list of accounts. This information is read in
	 * from the accounts.dat file.
	 * 
	...
	private static BankAccount parseBankAccount(String account) {
		return new BankAccount(Bank.parsePin(account), Bank.parseAccountNo(account), Bank.parseBalance(account),
